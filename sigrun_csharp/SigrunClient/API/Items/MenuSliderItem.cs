...
{
	public delegate void ItemSliderEvent(MenuSliderItem sender, int newIndex);
	public class MenuSliderItem : MenuItem
    {
        ...
        public MenuSliderItem(string text) : this(text, "", 100, 5, 0, SColor.HUD_Freemode, false)
        {
        }
        ...
        public MenuSliderItem(string text, string description) : this(text, description, 100, 5, 0, SColor.HUD_Freemode, false)
        {
        }
        public MenuSliderItem(string text, string description, bool heritage) : this(text, description, 100, 5, 0, SColor.HUD_Freemode, heritage)
        {
        }

        public MenuSliderItem(string text, string description, int max, int mult, int startVal, bool heritage) : this(text, description, max, mult, startVal, SColor.HUD_Freemode, heritage)
        {
        }
        /// <summary>
        /// List item, with slider.
        ...
        public MenuSliderItem(string text, string description, int max, int mult, int startVal, SColor sliderColor, bool heritage = false) : base(text, description)
        {
        ...
        {
            throw new Exception("MenuSliderItem cannot have a right badge.");
        }

        public override void SetRightLabel(string text)
        {
            throw new Exception("MenuSliderItem cannot have a right label.");
        }
